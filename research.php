  ...
  <body id="research">
   ...
   <?php include('navbar.html'); ?>
	...
	matter in the universe</h4>
      <p>The cosmic baryon fraction - the fraction of the universe's mass which is in the form of ordinary matter - can be approximated
	through study of the Cosmic Microwave Background. Yet when
	measuring the collected baryonic mass in clusters of galaxies
	- some of the largest cosmic scales - observations
	consistently find fewer baryons than would be expected from
	the CMB measurements. Many theories predict that feedback
	mechanisms (such as shock heating or supernovae) expell a
	large fraction of baryons from the gravitational potential of
	bound systems.</p> <p>For my senior thesis, advised by <a
	href="http://www.princeton.edu/astro/people/faculty/neta/">Prof. Neta
	...
	Milky Way and which &mdash; according to observations by <a
	href="http://www.stsci.edu/~tumlinso/COS-Halos/Welcome.html">The
	COS-Halos Group</a> &mdash; could have as much baryonic mass as the
	galaxy itself. Combined with measurements such as these, we
	concluded that most halos of galacitc masses or higher have
	actually retained the majority of the cosmic baryon fraction!
	You can read a copy of my Senior Thesis [<a
	href="files/Cook_Thesis.pdf">here</a>].</p>
